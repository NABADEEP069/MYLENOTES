...
const popularNotes = [
    ...
    },
    {
        imageSrc: "/notespageImages/nootes.jpeg",
        title: "Introduction to Algorithms",
        author: "Lecture Notes of CITK pfaoreitg  faoie  faoe aose  eriotwe  asoidfa f od fa odfi ",
        profilePic: "/dp.jpg",
        authorName: "Monalisha Roy",
        date: "22 July 2024",
    },
                ...
                <div key={index} className="w-80 md:w-72 lg:w-72 h-auto rounded-lg hover:bg-primary hover:bg-opacity-20 relative overflow-hidden flex flex-col justify-between">
                    <div className="h-full">
                        ...
                        <p className="px-3 mt-1 mb-1 text-text text-xs font-normal">
                            {note.author.length > 40 ? `${note.author.slice(0, 40)}...` : note.author}
                        </p>
                    ...
                    <div className="flex gap-1 mt-1 px-3 mb-3">
                        ...
                        />
                        <p className="px-3 pb-1 mt-1 text-text text-sm font-medium flex items-center">{note.authorName}</p>
                    </div>
                </div>
            ))}
        </div>
